...
<h4 class="bg-primary text-white p-3">
    #server.coldfusion.productname##structKeyExists( server, 'lucee' ) ? server.lucee.version : server.coldfusion.productversion#<br>
    Java #createObject( 'java', 'java.lang.System' ).getProperty( 'java.version' )#
</h4>
#trim( results )#
</cfoutput>
